...
# MAGIC %pip install --quiet mlflow==2.14.3 transformers==4.30.2 llama-index==0.10.62 pydantic==2.8.2 accelerate==0.20.3 PyPDF2
...
# The parse_bytes_pypdf function was created during our classroom setup using the PyPDF2 library.
# This function extracts text from a PDF file given its binary content.
