...
# MAGIC %pip install --quiet mlflow==2.14.3 transformers==4.44.0 llama-index==0.10.62 pydantic==2.8.2 accelerate nltk==3.8.1 PyPDF2
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS pdf_text_embeddings_lab (
