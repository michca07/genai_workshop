...
# MAGIC | **[Preparing Data for RAG Solutions]($./02 - Preparing Data for RAG)** | **Lecture -** Preparing Data for RAG Solutions </br> [Demo: Preparing Data for RAG]($./02 - Preparing Data for RAG/2.1 - Preparing Data for RAG) </br> [Lab: Preparing Data for RAG]($./02 - Preparing Data for RAG/2.LAB - Preparing Data for RAG) | 
# MAGIC | **[Mosaic AI Vector Search]($./03 - Mosaic AI Vector Search)** | **Lecture -** Introduction to Vector Stores </br> **Lecture -** Introduction to Mosaic AI Vector Search </br> [Demo: Create a "Self-Managed" Vector Search Index]($./03 - Mosaic AI Vector Search/3.1 - Create Self-managed Vector Search Index) </br> [Lab: Create a Managed Vector Search Index]($./03 - Mosaic AI Vector Search/3.LAB - Create Managed Vector Search Index) | 
# MAGIC | **[Assembling a RAG Application]($./04 - Assembling RAG App)** | **Lecture -** Assembling a RAG Application </br> [Demo: Assembling a RAG Application]($./04 - Assembling RAG App/4.1 - Assembling a RAG Application) </br> [Lab: Assembling a RAG Application]($./04 - Assembling RAG App/4.LAB - Assembling a RAG Application)
